...
PYBIND11_MODULE(_core, m) {
    ...
    py::class_<KPIConfig>(m, "KPIConfig")
        .def(py::init<const std::string&, const std::string&, const std::map<std::string, ParamType>&>(),
    ...
    m.def("macd", 
        py::overload_cast<const std::vector<Tick>&, const std::string&, int, int, int, int, const std::string&, const std::string&>(&macd),
        py::arg("ticks"), py::arg("campo"), py::arg("short_period"), py::arg("long_period"),
        py::arg("signal_period"), py::arg("n"), py::arg("source"), py::arg("direction") = "desc"
    );
    ...
    // === RSI FUNCTIONS ===
    m.def("rsi", 
        py::overload_cast<const std::vector<Tick>&, const std::string&, int, int>(&rsi),
        py::arg("ticks"), py::arg("field"), py::arg("n") = 14, py::arg("window") = 60
    );

    m.def("rsi", 
        py::overload_cast<const std::vector<double>&, int, int>(&rsi),
        py::arg("values"), py::arg("n") = 14, py::arg("window") = 60
    );
    ...
    m.def(
        ...
        py::arg("ticks"),
        py::arg("fields"),
        py::arg("passthrough") = std::vector<std::string>(),
